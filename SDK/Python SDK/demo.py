"""
Servo SDK demo — portfolio website prompt.
...
GOOGLE_API_KEY = os.environ.get("GOOGLE_AI_STUDIO_API_KEY", "AIzaSyBp5kqAZKjvxMBrQZQTmCQtAX3T3rI6Db0")
...
CATEGORIES = [
    ...
    RoutingCategory(id="complex", name="Complex", description="Multi-step reasoning required",     model="gemini-2.5-flash"),
]
CONFIG = RoutingConfig(default_category_id="simple", categories=CATEGORIES)

# ---------------------------------------------------------------------------
# Build client (bypass HTTP backend — uses local classifier + Google directly)
# ---------------------------------------------------------------------------

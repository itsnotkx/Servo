...
prompt = "I’m creating a task management app and want to know the main features users expect, " \
"a simple product description I could put on a landing page, " \
"and a sensible pricing structure for individuals and teams."

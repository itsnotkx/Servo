...
class LLMRouter:
    ...
    DEFAULT_TIER_MODELS: Dict[ComplexityLevel, str] = {
        ...
        ComplexityLevel.MEDIUM: "qwen-7b",
        ComplexityLevel.COMPLEX: "qwen-14b",
        ComplexityLevel.LONG_CONTEXT: "qwen-14b-128k",
        ComplexityLevel.CODE: "qwen-14b",
        ComplexityLevel.CREATIVE: "qwen-7b",
    }
    
    # Environment variable names for each tier
    ENV_VAR_MAPPING: Dict[ComplexityLevel, str] = {
        ComplexityLevel.SIMPLE: "TIER_SIMPLE_MODEL",
        ComplexityLevel.MEDIUM: "TIER_MEDIUM_MODEL",
        ComplexityLevel.COMPLEX: "TIER_COMPLEX_MODEL",
        ComplexityLevel.LONG_CONTEXT: "TIER_LONG_CONTEXT_MODEL",
        ComplexityLevel.CODE: "TIER_CODE_MODEL",
        ComplexityLevel.CREATIVE: "TIER_CREATIVE_MODEL",
    }
    ...
    def route(self, classification: ClassificationResult) -> str:
        ...
        return self.tier_models.get(
            complexity,
            self.tier_models[ComplexityLevel.MEDIUM]  # Fallback to medium
        )
    ...
    def get_model_for_tier(self, tier: str) -> str:
        ...
        try:
            ...
            return self.tier_models.get(level, self.tier_models[ComplexityLevel.MEDIUM])
        except ValueError:
            return self.tier_models[ComplexityLevel.MEDIUM]
